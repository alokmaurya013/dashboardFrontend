...
const StudentofClass=({url})=>{
    ...
    useEffect(() => {
      const fetchStudents = async () => {
        ...
        try {
          console.log(`${url}`);
          const response = await fetch(`${url}/api/display/studentofclass`, {
            method: 'GET',
            headers: {
          ...
          <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-24">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                  <div className="rounded-t mb-0 px-4 py-3 border-0">
                      <h3 className="font-semibold text-center text-blueGray-700">Class Students List</h3>
                      <div className="flex flex-wrap items-center">
                         ...
                         {userRole!=='Student'&&<div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                          ...
                          <tbody>
                              ...
                              {Array.isArray(students) && students.map((student) => {
                                  return <tr key={student._id}>
                                      ...
                                      {userRole!=='Student'&&<><td className="border-t-0 px-6 align-middle border border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
